...
***************************************
* Custom JQuery UI functions 
*/


/* UI Highlight and error scripts. */

/* Usage :

function test() {
$("#myDiv").writeAlert("Form submitted successfully.").fadeIn("slow").delay(10000).fadeOut("slow");
//$("#myDiv").writeError("Error submitted no way.").fadeIn("slow").delay(10000).fadeOut("slow");
}
