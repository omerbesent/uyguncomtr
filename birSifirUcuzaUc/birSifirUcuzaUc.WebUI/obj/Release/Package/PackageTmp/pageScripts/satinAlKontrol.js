...
window.addEventListener("message", function (event) {
    ...
    if (varmi < 0) {
        if (result.status) {
            window.location = "bilet_goster.php?pnr=" + result.resultfiled1 + "&email=" + result.resultfiled2; // Bilet oluştuysa yönlenilecek sayfa. Bu sayfada ticketinfo methodu kullanılarak bilet gösterilecek.
        }
        else {
